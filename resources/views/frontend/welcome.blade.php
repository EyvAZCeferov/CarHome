...
@section('content')
    <section class="content-wrap">
        <div data-elementor-type="wp-page" data-elementor-id="16519" class="elementor elementor-16519">
            ...
            {{-- Legal --}}
            @if(!empty(standartpages('niy-biz','type')) && isset(standartpages('niy-biz','type')->id) && !empty(standartpages('niy-biz','type')->id))
                    ...
                    <div class="fw-property-description-wrap fw-property-section-wrap" id="property-description-wrap">
                        <div class="block-wrap">
                            <div class="block-title-wrap">
                                <h2>{{ standartpages('niy-biz','type')->name[app()->getLocale().'_name'] }}</h2>
                            </div>
                            <div class="block-content-wrap">
                                <p>{!! standartpages('niy-biz','type')->description[app()->getLocale().'_description'] !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
